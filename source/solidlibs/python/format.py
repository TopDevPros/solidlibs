'''
    ...
    Copyright 2008-2023 TopDevPros
...
def pretty_html(html, parser=None):
    ...
    try:
        ...
        log('No module named bs4. Install bs4 package from pypi.')

    except FeatureNotFound:
        log(f'{parser} parser not found')
        ...
        try:
            ...
            if errors:
                ...
                if '<rss> is not recognized' in errors:
                    ...
                    pass
                    log(f"Warning: tidy prettyprinter found errors; see {DETAILED_LOG} for details")
    ...
    if not p_html:
        ...
        log('unable to prettyprint html')
        p_html = html
...
def strip_html(html):
    '''
        ...
        'Test HTML \\n \\n The test text'
        >>> html = '{# Copyright 2023 TopDevPros #}\\n<body>Another test</body>\\n</html>'
        >>> strip_html(html).strip()
        'Another test'
        >>> html = '<body>Yet another test</body>\\n{% block %}\\n something\\n {% endblock %}</html>'
        >>> strip_html(html).strip()
        'Yet another test \\n{% block %}\\n something'
        >>> html = '{% comment %}\\n Copyright 2023 TopDevPros\\n{% endcomment %}\\n<body>Last test</body>\\n</html>'
        >>> strip_html(html).strip()
        'Last test'
    '''
